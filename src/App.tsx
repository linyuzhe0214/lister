  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {/* Filters Section */}
        <div className={`${showMobileFilters ? 'flex' : 'hidden lg:flex'} flex-col gap-6 mb-8 bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100 animate-slide-up sticky top-[112px] z-30`}>
